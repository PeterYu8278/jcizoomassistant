        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           <div>
             <label className="block text-sm font-medium text-gray-700 mb-1">
                 Zoom Link <span className="text-gray-400 font-normal">(Optional)</span>
             </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-jci-blue focus:border-jci-blue sm:text-sm border p-2"
                  placeholder="Paste your link or leave empty to auto-generate"
                />
              </div>
          </div>
        </div>
            ...
            {isSubmitting ? (
              ...
              <>
                ...
                <span>
                  {editingMeeting 
                    ? 'Update Meeting' 
                    : (formData.manualZoomLink ? 'Book Meeting' : 'Create Zoom Meeting')
                  }
                </span>
              </>
            )}
